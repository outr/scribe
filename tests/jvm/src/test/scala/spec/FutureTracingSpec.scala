  ...
  "Future tracing" when {
    "using scribe implicits" should {
      ...
      "async trace back" in {
        ...
        val trace = exception.getStackTrace
        trace(0).getFileName should be("AsyncTesting.scala")
        trace(0).getLineNumber should be(34)

        trace(1).getFileName should be("AsyncTesting.scala")
        trace(1).getMethodName should be("three")
        trace(1).getLineNumber should be(32)

        trace(2).getFileName should be("AsyncTesting.scala")
        trace(2).getMethodName should be("two")
        trace(2).getLineNumber should be(25)

        trace(3).getFileName should be("AsyncTesting.scala")
        trace(3).getMethodName should be("one")
        trace(3).getLineNumber should be(17)

        trace(4).getFileName should be("AsyncTesting.scala")
        trace(4).getMethodName should be("position")
        trace(4).getLineNumber should be(10)
      }
    }
  }
}