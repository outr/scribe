...
```
libraryDependencies += "com.outr" %% "scribe" % "2.1.0"   // Scala
libraryDependencies += "com.outr" %%% "scribe" % "2.1.0"  // Scala.js / Scala Native / Cross-project
```
...
```
libraryDependencies += "com.outr" %% "scribe-slf4j" % "2.1.0"
```
...
```
libraryDependencies += "com.outr" %% "scribe-slack" % "2.1.0"
```
