...
```
libraryDependencies += "com.outr" %% "scribe" % "1.2.6"   // Scala
libraryDependencies += "com.outr" %%% "scribe" % "1.2.6"  // Scala.js
```
...
```
libraryDependencies += "com.outr" %% "scribe-slf4j" % "1.2.6"   // Scala
```